using System.Text;
using BlackCoffe.API.Data;
using BlackCoffe.API.Middleware;
using BlackCoffe.API.Models;
using BlackCoffe.API.Services.Implementations;
using BlackCoffe.API.Services.Interfaces;
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "BlackCoffe v1");
