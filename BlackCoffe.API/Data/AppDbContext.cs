...
public class AppDbContext : IdentityDbContext<Usuario>
{
        ...
        var produtos = new List<Produto>
    {
        ...
        new Produto { Id = 3, CategoriaId = 1, Nome = "Café em Grãos Espresso Forte", Descricao = "Café encorpado, ideal para máquinas de espresso.", Qtde = 60, ValorCusto = 27.00m, ValorVenda = 42.00m, Destaque = false, Foto = "/img/usuarios/1.png" },
        ...
        new Produto { Id = 6, CategoriaId = 2, Nome = "Café Moído Orgânico 250g", Descricao = "Café certificado, cultivado sem agrotóxicos e com torra artesanal.", Qtde = 70, ValorCusto = 18.00m, ValorVenda = 27.50m, Destaque = false, Foto = "/img/produtos/1.png" },
        ...
        new Produto { Id = 8, CategoriaId = 3, Nome = "Cápsulas Cappuccino Cremoso (10 un)", Descricao = "Mistura equilibrada de café e leite, com espuma cremosa.", Qtde = 60, ValorCusto = 20.00m, ValorVenda = 32.90m, Destaque = false, Foto = "/img/produtos/1.png" },
        new Produto { Id = 9, CategoriaId = 3, Nome = "Cápsulas Descafeinado Suave (10 un)", Descricao = "Sabor leve e aromático, ideal para consumo à noite.", Qtde = 50, ValorCusto = 17.00m, ValorVenda = 28.50m, Destaque = false, Foto = "/img/produtos/1.png" },
        ...
        new Produto { Id = 12, CategoriaId = 4, Nome = "Mocha Tradicional 300ml", Descricao = "Café espresso com leite vaporizado e calda de chocolate belga.", Qtde = 40, ValorCusto = 13.00m, ValorVenda = 19.50m, Destaque = false, Foto = "/img/produtos/1.png" },
        ...
        new Produto { Id = 15, CategoriaId = 5, Nome = "Xícara de Cerâmica 200ml", Descricao = "Xícara artesanal com design minimalista e acabamento fosco.", Qtde = 100, ValorCusto = 15.00m, ValorVenda = 25.00m, Destaque = false, Foto = "/img/produtos/1.png" },
        ...
        new Produto { Id = 18, CategoriaId = 6, Nome = "Balança Digital para Café", Descricao = "Balança de precisão com temporizador integrado.", Qtde = 30, ValorCusto = 100.00m, ValorVenda = 160.00m, Destaque = false, Foto = "/img/produtos/1.png" },
        ...
        new Produto { Id = 21, CategoriaId = 7, Nome = "Mini Brownie de Nozes (6 un)", Descricao = "Brownies artesanais com sabor intenso e textura macia.", Qtde = 50, ValorCusto = 18.00m, ValorVenda = 28.00m, Destaque = false, Foto = "/img/produtos/1.png" }
    };
